...
import { sanitizeHtml, hasContent, looksLikeHtml, htmlToText } from "@/lib/validators/sanitize-html";
...
// Re-export so callers needing the plain-text form (search, <meta>) have one import site.
export { htmlToText };
